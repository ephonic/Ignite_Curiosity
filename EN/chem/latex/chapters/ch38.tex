\chapter[Organic Reactions Need Not Be Memorized One by One]{Organic Reactions\protect\\ Need Not Be Memorized One by One}
...
\draw[->] (0,0) -- (8.4,0) node[above right]{\shortstack{Reaction\\progress}};
...
\node at (4.9,-0.3) [below right]{\shortstack[l]{Product B\\(stable, deep valley)}};
\end{tikzpicture}
\end{center}
