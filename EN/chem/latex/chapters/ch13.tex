...
\textbf{Fluoride toothpaste.} Tooth enamel is mainly hydroxyapatite, approximately \chem{Ca_{10}(PO_4)_{6}(OH)_2}. Bacterial acids slowly dissolve it, beginning cavities. Fluoride replaces surface hydroxyl groups to form fluorapatite, another calcium-salt crystal but much more acid-resistant. It gives enamel tougher armor. Dose matters here too: suitable amounts prevent decay, while prolonged excess causes mottling, so children's toothpaste concentration and quantity require care.
