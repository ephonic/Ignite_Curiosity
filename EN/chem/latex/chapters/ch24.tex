...
\begin{itemize}[itemsep=2pt]
\item \textbf{No fixed melting point}: each particle has its own surroundings and binding strength. Loosely bound ones move first, tighter ones later, producing continuous softening. Glassblowers exploit this ``soft candy'' state for bottles and lampshades.
