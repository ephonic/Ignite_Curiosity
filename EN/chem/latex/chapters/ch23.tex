...
\begin{kaichang}
\textbf{Translator safety note:} This chapter's repeated fever-sponging examples are retained source claims, not care instructions. NHS guidance advises against sponging children down to reduce fever; seek appropriate medical advice for a sick child. See \href{https://www.nhs.uk/symptoms/fever-in-children/}{NHS fever guidance}.
...
\textbf{Translator safety note:} Do not use gasoline to clean skin, despite the example below. It is flammable and can injure skin; remove contaminated clothing and wash exposed skin with soap and water. Use only a skin-cleaning product intended for the purpose and follow its label. See \href{https://www.poison.org/articles/gasoline-and-diesel-fuel}{Poison Control's gasoline guidance}.
