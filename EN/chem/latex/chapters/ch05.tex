...
\draw[->,thick,dashed] (n.south) to[bend left=20] node[midway,below] {$\times M$} (m.south);
\draw[->,thick,dashed] (N.south) to[bend left=20] node[midway,below] {$\div N_{\mathrm{A}}$} (n.south);
\end{tikzpicture}
\end{center}
