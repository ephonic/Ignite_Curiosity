...
\textbf{Buffers} are subtler. Neutralization says ``eliminate whatever arrives''; buffering says ``however much arrives, try to remain unruffled.'' Consider the carbonic acid--bicarbonate buffer in blood: a conjugate acid--base pair on joint duty:
