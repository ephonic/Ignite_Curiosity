\chapter{Beyond Lower Energy: Entropy and Free Energy}
...
\node[anchor=north] at (2,-0.2) {\shortstack{Before removal:\\few arrangements}};
...
\node[anchor=north] at (7.5,-0.2) {\shortstack{After: many\\dispersed arrangements}};
\end{tikzpicture}
\end{center}
...
\midrule
\shortstack{Negative\\(exothermic)} & \shortstack{Positive\\(entropy rises)} & \shortstack{Always\\negative} & \shortstack[l]{Always spontaneous,\\e.g. burning} \\
\shortstack{Positive\\(endothermic)} & \shortstack{Positive\\(entropy rises)} & \shortstack{Negative\\when hot} & \shortstack[l]{Hotter favors it:\\cold packs, calcination} \\
\shortstack{Negative\\(exothermic)} & \shortstack{Negative\\(entropy falls)} & \shortstack{Negative\\when cold} & \shortstack[l]{Colder favors it:\\freezing water} \\
\shortstack{Positive\\(endothermic)} & \shortstack{Negative\\(entropy falls)} & \shortstack{Always\\positive} & Never spontaneous \\
\bottomrule
\end{tabular}
\end{table}
