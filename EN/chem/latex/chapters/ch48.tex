...
\draw[->,thick] (a) -- node[above=18pt]{\scriptsize \shortstack{Hydrogen\\bonds}} (b);
\draw[->,thick] (b) -- node[above=18pt]{\scriptsize \shortstack{Side-chain\\interactions}} (c);
\draw[->,thick] (c) -- node[above=18pt]{\scriptsize Assembly} (d);
