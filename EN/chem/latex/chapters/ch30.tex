\chapter{How Catalysts Find Another Route}
...
\draw[<->] (7.6,1.0) -- (7.6,4.3) node[midway,right] {Old-route peak};
\draw[<->] (8.6,1.0) -- (8.6,3.1) node[midway,right] {New-route peak};
\node at (1.0,2.85) {Reactants};
\node at (6.4,0.6) {Products};
\node[align=center] at (3.4,5.0) {Solid: uncatalyzed\quad Dashed: catalyzed};
\end{tikzpicture}
\end{center}
