...
\textbf{Step one: Chapters $1$--$4$, foundations.} Start with letters, equations, and functions to practise thinking with symbols. These chapters supply the book's shared language, needed on any later route. Read them in order and consult Appendix B whenever elementary material is unfamiliar.
