...
Now put functions inside functions, as in $y=(x^2+1)^3$. The inner layer is $u=x^2+1$, the outer layer $u^3$. Intuitively, $x$ changes, then $u$, then $y$. The rates should multiply along the chain.
