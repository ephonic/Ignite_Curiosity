...
Chapter 1 showed the power of symbols: a symbol can represent any number, allowing one equality to summarize infinitely many specific problems. Our first major step here is to turn guessing into translation. Translate the problem into equalities, then let the equalities tell us the answer.
