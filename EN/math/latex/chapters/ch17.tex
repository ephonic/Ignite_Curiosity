...
\begin{dingyi}
A surface's \textbf{tangent plane} at $P$ touches the surface at $P$ and contains all its directions at that point. A vector in this plane starting at $P$ is a \textbf{tangent vector} to the surface at $P$.
\end{dingyi}
...
\begin{tabular}{llll}
\toprule
Surface & Triangle angle sum & Geodesics & \shortstack[l]{Flattens without\\stretching?} \\
\midrule
Plane & Exactly $180^\circ$ & Straight lines & Already flat \\
Sphere & \shortstack[l]{Above $180^\circ$; greater excess\\for larger triangles} & Great-circle arcs & No: it splits \\
Cylinder & Exactly $180^\circ$ & \shortstack[l]{Straight when unrolled;\\possibly helices} & Yes \\
Saddle & Below $180^\circ$ & \shortstack[l]{Outward-diverging\\curves} & No: it wrinkles \\
\bottomrule
\end{tabular}
\end{table}
