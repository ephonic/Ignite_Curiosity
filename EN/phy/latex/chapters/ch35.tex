...
\[
  d\sin\theta = m\lambda \ \text{(bright fringes)},\qquad
  d\sin\theta = \left(m+\tfrac12\right)\lambda \ \text{(dark fringes)},\qquad m=0,1,2,\dots
\]
...
\begin{tikzpicture}[scale=1.0]
  ...
  \draw[-{Stealth[length=2.5mm]}] (-4.2,0) -- (4.4,0) node[below left] {Screen position};
