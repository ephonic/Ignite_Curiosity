...
\]
This quantifies harsh taxes: doubling \(\Delta v\) requires \emph{squaring} the mass ratio \(m_0/m_{\text{final}}\). Logarithmic growth makes fuel requirements explode. Staging and discarding spent casings fights this logarithm for every penny.
