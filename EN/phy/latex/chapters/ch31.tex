...
\chapter{Statistical Physics: Probability for Vast Populations}
...
\textbf{Draw it:} for \(0\) through \(10\) heads, the counts are \(1,10,45,120,210,252,210,120,45,10,1\). Plot them to explain the histogram.

\begin{center}
\begin{tikzpicture}[x=0.95cm,y=0.85cm]
  \draw[-{Stealth}] (-0.4,0) -- (11.6,0);
  \node[below] at (5.5,-0.1) {Number of heads};
