...
\textbf{Translator safety note:} This museum example is not permission to touch high-voltage equipment. Use only an organized demonstration following its apparatus-specific safety procedures; painful discharges and pacemaker hazards require precautions. See \href{https://physicslabs.colorado.edu/demos/electricity-and-magnetism/electrostatics/electrostatic-machines/dissectible-van-de-graaff/}{University of Colorado demonstration warnings}.
...
% BEGIN TRANSLATOR SAFETY NOTE
\textbf{Translator safety note:} The following claim about touching transmission wires is unsafe: a grounded person can receive a fatal shock from one energized conductor alone. Never touch or approach power conductors. See \href{https://www.osha.gov/etools/poultry-processing/plant-wide-hazards/electrical-hazards}{OSHA electrical-hazard guidance}.
% END TRANSLATOR SAFETY NOTE
...
% BEGIN TRANSLATOR SAFETY NOTE
\textbf{Translator safety note:} The source's voltage and stored-energy estimate does not establish that contact is harmless. Do not reproduce a bodily discharge or test electrical safety on yourself; apparatus-specific precautions remain essential. See \href{https://physicslabs.colorado.edu/demos/electricity-and-magnetism/electrostatics/electrostatic-machines/dissectible-van-de-graaff/}{University of Colorado high-voltage warnings}.
% END TRANSLATOR SAFETY NOTE
...
% BEGIN TRANSLATOR SAFETY NOTE
\textbf{Translator safety note:} Do not deliberately create or investigate sparks at an outlet. The source's air-gap estimate is not a test of an outlet's voltage or safety. Energized equipment presents shock and fire hazards; see \href{https://www.osha.gov/etools/poultry-processing/plant-wide-hazards/electrical-hazards}{OSHA electrical-hazard guidance}.
% END TRANSLATOR SAFETY NOTE
