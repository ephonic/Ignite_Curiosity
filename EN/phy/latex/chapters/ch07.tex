...
\textbf{Translator safety note:} Do not ride while holding or opening an umbrella, even in an open area: this can impair steering and destabilize the bicycle. Use the paper-drop experiment or a video instead. \href{https://www.nhtsa.gov/road-safety/bicycle-safety}{NHTSA bicycle-safety guidance} recommends keeping both hands on the handlebars except when signaling and securing carried items.
