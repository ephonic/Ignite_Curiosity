...
\begin{itemize}[leftmargin=2em]
  ...
  \item Amplitude \(A\) is absent. Double amplitude and period stays unchanged. The spoon's counterintuitive behavior has become a prediction. This holds only for strictly displacement-proportional restoration, a central limitation later.
\end{itemize}
