...
\begin{tikzpicture}[scale=1.0]
  ...
  \node[left] at (0,-1.9) {\shortstack{Submerged\\block}};
  ...
  \node[above] at (3.5,0.2) {Top: less downward pressure};
  ...
  \node[right] at (5.4,-2.8) {Sides cancel};
  % Net buoyancy
  \draw[-{Stealth[length=4mm]},very thick,orange!80!black] (5.6,-2.6) -- (5.6,-0.9);
  \node[right] at (5.6,-1.0) {\shortstack[l]{Net: upward\\buoyancy}};
\end{tikzpicture}
\end{center}
