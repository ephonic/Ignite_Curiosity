...
\begin{tikzpicture}[scale=1.0,>=Stealth]
  ...
  \node at (2.0,-1.8) {Edge-wavelet path difference $\lambda$: cancellation in direction $\theta$};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=1.35,>=Stealth]
  \draw[->] (0,0) -- (3.6,0) node[right] {Aperture $d$};
