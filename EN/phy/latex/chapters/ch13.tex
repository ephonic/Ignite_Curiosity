...
\begin{tikzpicture}[scale=0.09]
  ...
  % Labels
  \node[red!70!black] at (20,9) {\shortstack{More fast\\running}};
  \node[red!70!black,rotate=-73] at (49,-14) {\shortstack{Less slow\\swimming}};
  \node[blue!70!black,rotate=-53] at (14,-16) {\shortstack{Shortest,\\not quickest}};
\end{tikzpicture}
\end{center}
