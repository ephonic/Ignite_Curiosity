...
Algebra's central move is replacing numbers with letters, allowing us to study calculation rules independently of specific values. The letter $x$ is not a mysterious number but a placeholder: it holds a space so a pattern can emerge.
